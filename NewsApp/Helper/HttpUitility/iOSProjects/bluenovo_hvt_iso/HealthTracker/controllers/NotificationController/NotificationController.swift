...
class NotificationController: InterfaceExtendedController {
...
//    var tabbarController : UITabBarController?
    ...
    override func viewDidLoad() {
        ...
        paintLogout()
        paintNavigationTitle(text: "Notifications".localized())
        paintHideBackButton()
    }
    
    override func viewWillAppear(_ animated: Bool) {
        super.viewWillAppear(true)
        tabBarController?.title = "Notifications".localized()
    }
